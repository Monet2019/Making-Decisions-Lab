...
if (temperature >= 80 && rain) {
  ...
  console.log('Wear appropriate clothing for the temperature.')
}
...
while (z > 0) { //created while loop*/
  for (let i = z; i >= 1; i--) { //for loop
    countdown += `${i}, `
    //console.log(i)
  }
  //countdown = countdown(0, 1); //Syntax string.slice(start,end) First character is 0.- doesn't work  Tried split method.-does work.
